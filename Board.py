                ...
                for yi in [-1, 1]:
                    ...
                    while (self.isEmpty(currentPosition)):
                        ...
                        if self.isBlack(currentPosition.add(xi,yi)) and self.isEmpty(currentPosition.add(2*yi, 2*xi)):
                            ...
                            list2.append(FurtherCaptures(self.make_single_move(currentPosition.add(2 * xi, 2 * yi),self.capture_possible()),currentPosition.add(2 * xi, 2 * yi), new_list,king))
        return list2;
                ...
                if not white.king:
                    for i in [-1, 1]:
                        if self.isBlack(white.position().add(1, i)) and self.isEmpty(white.position().add(2, 2*i)):
                            ...
                            self.FurtherCaptures(self.make_single_move(white.position(),white.position().add(2, 2*i),self.capture_possible()).copy(),white.position(),white.position().add(2,2*i),white.king,list2.copy(),ans)
